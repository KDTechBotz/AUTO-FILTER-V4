    ...
    try:
        ...
        if settings['max_btn']:
            ...
            if n_offset == 0:
                ...
                btn.append([InlineKeyboardButton("🔰", callback_data="pages"), InlineKeyboardButton(f"{math.ceil(int(offset)/10)+1} / {math.ceil(total/10)}", callback_data="pages"), InlineKeyboardButton("Next ▶️", callback_data=f"next_{req}_{key}_{n_offset}")])
            else:
                btn.append(
                    [
            ...
            if n_offset == 0:
                ...
                btn.append([InlineKeyboardButton("🔰", callback_data="pages"), InlineKeyboardButton(f"{math.ceil(int(offset)/int(MAX_B_TN))+1} / {math.ceil(total/int(MAX_B_TN))}", callback_data="pages"), InlineKeyboardButton("Next ▶️", callback_data=f"next_{req}_{key}_{n_offset}")])
            else:
                btn.append(
                    [
                        InlineKeyboardButton("◀️ Back", callback_data=f"next_{req}_{key}_{off_set}"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('‼️ DMCA', callback_data="owner_info"),
                    InlineKeyboardButton('Movie Group 🎪', url="https://t.me/+Qw1Mf7bTF7k5ZDZl")
                ],[
        ...
        buttons = [[
            InlineKeyboardButton('◀️ Back ▶️', callback_data='filters')
        ]]
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
        ...
        buttons = [[
            InlineKeyboardButton('💼 Filters Mod', callback_data='filters'),
        ...
        buttons = [[
            InlineKeyboardButton('◀️ Back ▶️', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await client.edit_message_media(
            query.message.chat.id, 
        ...
        buttons = [[
            InlineKeyboardButton('◀️ Back ▶️', callback_data='manuelfilter')
        ]]
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
        ...
        buttons = [[
            InlineKeyboardButton('◀️ Back ▶️', callback_data='help')
        ]]
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
        ...
        buttons = [[
            InlineKeyboardButton('◀️ Back ▶️', callback_data='extra')
        ]]
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("◀️ Back", callback_data="start"),
                    InlineKeyboardButton("Contact ☎️", url=f"https://t.me/DQ12335")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        try:
            ...
            if settings['max_btn']:
                btn.append(
                    [InlineKeyboardButton("🔰", callback_data="pages"), InlineKeyboardButton(text=f"1/{math.ceil(int(total_results)/10)}",callback_data="pages"), InlineKeyboardButton(text="Next ▶️",callback_data=f"next_{req}_{key}_{offset}")]
                )
            else:
                btn.append(
                    [InlineKeyboardButton("🔰", callback_data="pages"), InlineKeyboardButton(text=f"1/{math.ceil(int(total_results)/int(MAX_B_TN))}",callback_data="pages"), InlineKeyboardButton(text="Next ▶️",callback_data=f"next_{req}_{key}_{offset}")]
                )
        except KeyError:
        ...
        btn.append(
            [InlineKeyboardButton(text="!  ɴᴏ ᴍᴏʀᴇ ᴩᴀɢᴇꜱ ᴀᴠᴀɪʟᴀʙʟᴇ  !",callback_data="pages")]
        )
    ...
    if imdb:
        ...
        cap = f"<b>Rᴇǫᴜᴇsᴛᴇᴅ Mᴏᴠɪᴇ Nᴀᴍᴇ :</b><code>{search}</code>\n\n<b><u>Note : Files Sended To PM Check In Private</u></b>"
