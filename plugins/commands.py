...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    InlineKeyboardButton('🎪 Join Movie Request Group 🎪', url="https://t.me/+Qw1Mf7bTF7k5ZDZl")
                  ]]
    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🎪 Movie Group 🎪', url=f"https://t.me/+Qw1Mf7bTF7k5ZDZl") ] ] ),
            )
        return
