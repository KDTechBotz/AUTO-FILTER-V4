...
# Bot images & videos
PICS = (environ.get('PICS', 'https://envs.sh/0gQ.jpg')).split()
...
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/0gh.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/0gd.jpg")
...
DATABASE_NAME = environ.get('DATABASE_NAME', "AutoFilterBotV3")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'BOTFILES')
